    ...
    <Container>
      ...
      >
        <ContainerModal>
          ...
          <CaptionModal>
            Esse aplicativo tem como objetivo te direcionar na sua jornada rumo
            ao sucesso.
          </CaptionModal>
          <ParagraphModal>
            Antes de dar início, gostaria de fazermos algumas observações:{" "}
          </ParagraphModal>
          <ListModal>
            <li>
            ...
            <li>
              ...
              chegar lá? Mas lembre-se metas razoáveis são mais fáceis de
            ...
            <li>
              ...
              atento as suas emoções envolvidas nesse processo e gerencie as
              suas frustrações. Você poderá ficar frustrado porque teve
              dificuldades, porque o conteúdo atual é mais difícil, por que está
              passando por problemas pessoais ou porque teve menos tempo essa
              semana. Lembre-se- se que feito é melhor que perfeito. Se manter
            ...
            <li>
              ...
              perfeito e disponibilidade perfeita. Então sim, você irá falhar,
              mas isso não precisa ser determinante para você desistir.
            </li>
          </ListModal>
